      ...
      return (
        ...
        >
          ...
          <div className="bg-white p-6 rounded-xl shadow-md max-w-5xl mx-auto">
            <h1 className="text-4xl font-heading font-bold mb-1 text-gray-800">{park.name}</h1>
            <p className="text-gray-500 text-sm mb-1">{park.state}</p>
            <p className="text-sm text-gray-400">📍 {park.coordinates}</p>
            ...
            {weather.length > 0 ? (
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  {weather.map((day) => (
                    <div key={day.date} className="bg-gray-50 p-4 rounded-lg shadow">
            ...
            {["placesToVisit", "nearbyFoods", "hotelsAndCampgrounds"].map((key, idx) =>
              park[key]?.length > 0 ? (
