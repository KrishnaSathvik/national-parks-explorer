    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-pink-50 to-pink-100 py-12 px-4 font-sans">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white/80 backdrop-blur-md border border-white p-6 sm:p-10 rounded-3xl shadow-xl">
          <h1 className="text-3xl sm:text-4xl font-heading font-extrabold text-center mb-10 text-pink-600">
            ⭐ Your Favorites
          </h1>
...
const Section = ({ title, loading, empty, children }) => (
  <div className="mb-12">
    <h2 className="text-xl sm:text-2xl font-heading font-semibold mb-4 text-gray-700">
      {title}
    </h2>
    {loading ? (
